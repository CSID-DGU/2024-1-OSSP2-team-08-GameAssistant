...
ui_file_path_select_img = os.path.join(base_dir, "UI", "SelectImg.ui")
ui_file_path_capture_helper = os.path.join(base_dir, "UI", "CaptureHelper.ui")

ImgSelectWindowSource = uic.loadUiType(ui_file_path_select_img)[0]
CaptureHelperSource = uic.loadUiType(ui_file_path_capture_helper)[0]
