...
class TierItemUI(QWidget, TierItemSource):
    ...
    def SetInfo(self, c_list):
        ...
        self.TierIMG.setPixmap(QPixmap(":/tiers/Tier/" + str(c_list[4]) + ".png"))
        self.CharIMG.setPixmap(QPixmap(":/champions/Champions/Mini/" + str(c_list[5]) + ".png"))
