...
json_file_path1 = os.path.join(current_dir, '..', '..', 'Data', 'TestJson', 'captureJson', 'SaveDate.json')
json_file_path1 = os.path.abspath(json_file_path1)
json_file_path2 = os.path.join(current_dir, '..', '..', 'Data', 'TestJson', 'captureJson', 'Regions.json')
...
class CaptureHelperUI(QWidget, CaptureHelperSource):
    def __init__(self, fpath):
        ...
        self.__file_path = json_file_path2
